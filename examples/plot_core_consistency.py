...
def fit_parafac(X, num_components, num_inits=5):
    ...
    cp_tensor = component_vis.multimodel_evaluation.get_model_with_lowest_error(model_candidates, X)
    return component_vis.postprocessing.postprocess(cp_tensor, dataset=aminoacids)
...
###############################################################################
component_vis.visualisation.core_element_heatmap(four_component_cp, aminoacids)
plt.show()
...
###############################################################################
component_vis.visualisation.core_element_plot(four_component_cp, aminoacids)
plt.show()
...
ax = component_vis.visualisation.scree_plot(models, aminoacids, metric="Core consistency")
ax.set_ylim(0, 105)
plt.show()
...
###############################################################################
component_vis.visualisation.core_element_heatmap(models[3], aminoacids)
plt.show()

###############################################################################
component_vis.visualisation.core_element_plot(models[3], aminoacids)
plt.show()
