...
def test_permute_cp_tensor(rng):
    ...
    permutation = [2, 1, 3, 0]
    cp_tensor_permuted = (w[permutation], (A[:, permutation], B[:, permutation], C[:, permutation]))
    ...
    cp_tensor_permuted2 = (w[permutation_2comp], (A[:, permutation_2comp], B[:, permutation_2comp], C[:, permutation_2comp]))
